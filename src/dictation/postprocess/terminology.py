...
_RULES: List[_Rule] = [
    ...
    (_ci(r"\bedematous\b"), "oedematous"),
    (_ci(r"\banaemia\b"), "anaemia"),
    (_ci(r"\banemic\b"), "anaemic"),
    (_ci(r"\bh[ae]morrhages\b"), "haemorrhages"),
    (_ci(r"\bh[ae]morrhage\b"), "haemorrhage"),
    (_ci(r"\bh[ae]morrhagic\b"), "haemorrhagic"),
    (_ci(r"\borthop(?:ae|e)dic\b"), "orthopaedic"),
    (_ci(r"\besophageal\b"), "oesophageal"),
    (_ci(r"\besophagus\b"), "oesophagus"),
    (_ci(r"\besophagitis\b"), "oesophagitis"),
    (_ci(r"\banesthetics\b"), "anaesthetics"),
    (_ci(r"\banesthetic\b"), "anaesthetic"),
    (_ci(r"\banesthesia\b"), "anaesthesia"),
    (_ci(r"\bleukemic\b"), "leukaemic"),
    (_ci(r"\bleukemia\b"), "leukaemia"),
    (_ci(r"\bdiarrhea\b"), "diarrhoea"),
    (_ci(r"\bfetal\b"), "foetal"),
    (_ci(r"\bfetus\b"), "foetus"),
    (_ci(r"\bhemoglobin\b"), "haemoglobin"),
    (_ci(r"\bcesarean\b"), "caesarean"),
    (_ci(r"\bcesarian\b"), "caesarean"),
    (_ci(r"\bgynecological\b"), "gynaecological"),
    (_ci(r"\bgynecology\b"), "gynaecology"),
    (_ci(r"\bestrogen\b"), "oestrogen"),
    (_ci(r"\bhemodynamically\b"), "haemodynamically"),
    (_ci(r"\bhemodynamic\b"), "haemodynamic"),
    (_ci(r"\bhemothorax\b"), "haemothorax"),
    (_ci(r"\bhemoptysis\b"), "haemoptysis"),
    (_ci(r"\bfecal\b"), "faecal"),
    (_ci(r"\bfeces\b"), "faeces"),
    (_ci(r"\bischemic\b"), "ischaemic"),
    (_ci(r"\bischemia\b"), "ischaemia"),
    (_ci(r"\bhematological\b"), "haematological"),
    (_ci(r"\bhematology\b"), "haematology"),
    (_ci(r"\bhemostatic\b"), "haemostatic"),
    (_ci(r"\bhemostasis\b"), "haemostasis"),
